...
assert 'page.title=@"卐解 1.8.1 UI1.2 9.25-01"' in plugin
...
assert 'BDSpoofer_1.8.1_UI1.2_9.25-01.dylib' in build and 'UI1.1.dylib' not in build
assert 'BDSpooferCraneManager_1.0.2-ui1_9.25-01_RootHide.deb' in build
...
assert 'self.title = @"卍解 1.0.2 9.25-01"' in manager
...
assert manager_info['CFBundleVersion']=='9.25.01' and manager_info['CFBundleShortVersionString']=='1.0.2-9.25.01'
